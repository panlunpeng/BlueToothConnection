...
public class DeviceControlActivity extends Activity {
	...
	private static final int RSSICOMPLETE = 0;
	...
	private final ExpandableListView.OnChildClickListener servicesListClickListner = new ExpandableListView.OnChildClickListener() {
		...
		public boolean onChildClick(ExpandableListView parent, View v,
			...
			if (mGattCharacteristics != null) {
				...
				if (characteristic.getUuid().toString()
						.equals("00001524-1212-efde-1523-785feabcd123")) {
					characteristic.setValue("A".getBytes());
					mBluetoothLeService.wirteCharacteristic(characteristic);
				}
				if (characteristic.getUuid().toString()
						.equals("00001525-1212-efde-1523-785feabcd123")) {
					characteristic.setValue("A".getBytes());
					mBluetoothLeService.wirteCharacteristic(characteristic);
				}
...
//		final Thread rssiThread = new Thread(new Runnable() {
//			@Override
//			public void run() {
//				int rssi = 15;
//				mBluetoothLeService.getRssiVal();
...
//			if (msg.what == RSSICOMPLETE) {
//				rssi.setText("RSSI:-"+ msg.arg1 + "db");
//			}
//		}
//	};
	...
	public static void readRssi(int rssi) {
		System.out.println("plp rssi = " + rssi);
	}
